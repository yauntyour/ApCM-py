...
if __name__ == "__main__":
    ...
    logging.info(f"加载数据形状: {test_data_flat.shape}")

    # ==================== 参数设置 ====================
    input_dim = test_data_flat.shape[1]  # 1024
    m_dim = 256
    ...
    X_train_np = test_data_flat.cpu().numpy()
    ...
    visualize_comparison(
        ...
        save_path=f"assets/PCA_Example_RR_{input_dim//m_dim}to1.png",
    )
    ...
    logging.info(f" 训练数据: {len(test_data_flat)} 张真实图像")
